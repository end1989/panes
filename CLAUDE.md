...
Panes is a zero-dependency, single-file multi-stream viewer. Vanilla HTML/CSS/JavaScript, no frameworks, no build system. The entire application is `panes.html`.

## Running

No build step. Open `panes.html` in a browser, or use the Windows batch launchers:
...
**Single-file monolith:** `panes.html` contains all HTML, CSS, and JavaScript inline.
